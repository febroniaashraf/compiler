...
int initial_values(queue<int> &whichPartition,map<int,vector<int> > &partitions,vector<int> &NonFinalStates,
                   vector<vector<int>> &finalStatesRelated, std::map<int, int> &keyOfStates);
